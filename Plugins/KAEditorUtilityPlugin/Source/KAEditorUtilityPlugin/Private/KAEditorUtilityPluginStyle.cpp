...
TSharedPtr<FSlateStyleSet> FKAEditorUtilityPluginStyle::StyleInstance = nullptr;

void FKAEditorUtilityPluginStyle::Initialize()
{
...
void FKAEditorUtilityPluginStyle::Shutdown()
{
...
FName FKAEditorUtilityPluginStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("KAEditorUtilityPluginStyle"));
	return StyleSetName;
}
...
TSharedRef< FSlateStyleSet > FKAEditorUtilityPluginStyle::Create()
{
...
void FKAEditorUtilityPluginStyle::ReloadTextures()
{
...
const ISlateStyle& FKAEditorUtilityPluginStyle::Get()
{
